...
In this stage, we first need to transformed the data into the categorized format. This function will calculate the scaling based on the argument the user provided.
...
- time: `time`, it needs to be an integer variable.
...
- group: the column name that distinguish between the values group.
- ncat: the number of categories to be created for scaling values.
- breaks: a vector for creating a bins.
- label: a vector to provided a label to the qtile.
